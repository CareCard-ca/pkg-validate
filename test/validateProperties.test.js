...
describe('ValidateProperties test', function () {
    ...
    describe('UUID fields (isValidUuidString)', function () {
        const uuidKeys = [
            ...
            'program_id',
            'programId',
            'program_requirement_for_user_id',
            'programRequirementForUserId',
            'document_item_status_id',
            'documentItemStatusId',
            'requirement_item_id',
            'requirementItemId',
            'program_document_id',
            'programDocumentId',
    ...
    describe('General behaviour', function () {
        ...
        it('validates a comprehensive object containing every supported key', function () {
            const testObject = {
                ...
                program_requirement_for_user_id: VALID_UUID,
                programRequirementForUserId: VALID_UUID,
                document_item_status_id: VALID_UUID,
                documentItemStatusId: VALID_UUID,
