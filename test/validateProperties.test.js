...
function assertAccepts(key, value) {
  ...
  assert.deepStrictEqual(
    out,
    { [key]: value },
    `Expected key "${key}" to be accepted for value: ${JSON.stringify(value)}`,
  );
}
...
function assertRejects(key, value) {
  ...
  assert.deepStrictEqual(
    out,
    {},
    `Expected key "${key}" to be rejected for value: ${JSON.stringify(value)}`,
  );
}
  ...
  describe('General behaviour', function () {
    ...
    it('validates a comprehensive object containing every supported key', function () {
      const testObject = {
        ...
        program_template_id: VALID_UUID,
        programTemplateId: VALID_UUID,
        user_item_id: VALID_UUID,
        userItemId: VALID_UUID,
        user_item_status_id: VALID_UUID,
        userItemStatusId: VALID_UUID,
        requirement_item_id: VALID_UUID,
        requirementItemId: VALID_UUID,
